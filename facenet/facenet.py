...
class Facenet(object):
    ...
    def detect_image(self, image_1, image_2):
        ...
        #   图片预处理，归一化
        #---------------------------------------------------#
        logger.bind(ns=time.time_ns()).debug('App: come into "detect_image"')
        with torch.no_grad():
            ...
            logger.bind(ns=time.time_ns()).debug('App: get image')
            ...
            logger.bind(ns=time.time_ns()).debug('App: get photo')
            ...
            output1 = self.net(photo_1).numpy()


            logger.bind(ns=time.time_ns()).debug('App: get output1')


            output2 = self.net(photo_2).cpu().numpy()

            logger.bind(ns=time.time_ns()).debug('App: get output2')
            ...
            logger.bind(ns=time.time_ns()).debug('App: get return value')
